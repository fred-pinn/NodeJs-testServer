...
var HtmlRender = /** @class */ (function () {
    ...
    HtmlRender.prototype.formatIntoHtml = function (view) {
        ...
        try {
            ...
            if (view.isBold || view.isBold == false) {
                toolTip += "\r\n" + "isBold: " + view.isBold;
            }
            if (view.isItalic || view.isItalic == false) {
                toolTip += "\r\n" + "isItalic: " + view.isItalic;
            }
            if (view.isChecked != null) {
            ...
            if (view.text != null) {
                ...
                if (view.textSize != null) {
                    textFormatting += "font-size:" + view.textSize + "px;";
                }
                if (view.isBold) {
                    textFormatting += "font-weight:bold;";
                }
                if (view.isItalic) {
            ...
            if (view.paddingLeft != null)
                padding += "padding-left:" + view.paddingLeft + "px;";
            if (view.paddingBottom != null)
                padding += "padding-bottom:" + view.paddingBottom + "px;";
            if (view.paddingRight != null)
                padding += "padding-right:" + view.paddingRight + "px;";
            if (noPadding) {
